    ...
    createClass(Gantt, [{
        ...
        value: function setup_gantt_dates() {
            ...
            if (this.view_is(['Quarter Day', 'Half Day', 'Week'])) {
                ...
                this.gantt_start = date_utils.start_of(date_utils.add(this.gantt_start, -1, 'month'), 'month');
                this.gantt_end = date_utils.start_of(date_utils.add(this.gantt_end, 1, 'month'), 'month');
